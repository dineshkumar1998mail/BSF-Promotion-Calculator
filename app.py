...
def calculate_scenarios(df, target_sno, target_ret):
    ...
    # Proportional VRS Drop Distribution for Sim Columns
    np.random.seed(42)
    ...
    # Simulation Logic for VRS and CR Columns
...
if irla_input:
    ...
    if not off.empty:
        ...
        c4.metric("Retirement Date", target['Retirement_Date'].strftime('%d-%m-%y'))
        ...
        st.divider()
        st.subheader("📅 Seniority Tracker (Projected Jan 1st)")
